...
/**
 * Entry point of the 'SpringDWR' generation module.
 *
 * @generated
 */
public class SpringDWR extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/acceleo/module/pim/uml21/gen/java/spring/migrated/files/springDWR";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "springDWRModel" };
     ...
     * @generated
     */
    public SpringDWR(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public SpringDWR(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                SpringDWR generator = new SpringDWR(modelURI, folder, arguments);
