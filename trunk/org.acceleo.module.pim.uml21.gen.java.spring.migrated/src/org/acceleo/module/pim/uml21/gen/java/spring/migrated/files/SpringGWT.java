...
/**
 * Entry point of the 'SpringGWT' generation module.
 *
 * @generated
 */
public class SpringGWT extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/acceleo/module/pim/uml21/gen/java/spring/migrated/files/springGWT";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "springGWTClass", "springGWTModel" };
     ...
     * @generated
     */
    public SpringGWT(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public SpringGWT(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                SpringGWT generator = new SpringGWT(modelURI, folder, arguments);
